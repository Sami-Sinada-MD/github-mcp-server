...
| <picture><source media="(prefers-color-scheme: dark)" srcset="../pkg/octicons/icons/shield-lock-dark.png"><source media="(prefers-color-scheme: light)" srcset="../pkg/octicons/icons/shield-lock-light.png"><img src="../pkg/octicons/icons/shield-lock-light.png" width="20" height="20" alt="shield-lock"></picture><br>`credentials` | Repository credentials such as GitHub Actions secrets | https://api.githubcopilot.com/mcp/x/credentials | [Install](https://insiders.vscode.dev/redirect/mcp/install?name=gh-credentials&config=%7B%22type%22%3A%20%22http%22%2C%22url%22%3A%20%22https%3A%2F%2Fapi.githubcopilot.com%2Fmcp%2Fx%2Fcredentials%22%7D) | [read-only](https://api.githubcopilot.com/mcp/x/credentials/readonly) | [Install read-only](https://insiders.vscode.dev/redirect/mcp/install?name=gh-credentials&config=%7B%22type%22%3A%20%22http%22%2C%22url%22%3A%20%22https%3A%2F%2Fapi.githubcopilot.com%2Fmcp%2Fx%2Fcredentials%2Freadonly%22%7D) |
